...
This currently requires dnx version - 1.0.0-beta4.. and because the omnisharp server uses kestrel, you'll also need to make sure that you have libuv installed.
